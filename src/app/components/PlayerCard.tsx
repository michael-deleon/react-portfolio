...
const PlayerCard: React.FC<PlayerCardProps> = ({ project }) => {
  return (
    <a href={project.link} rel="noopener noreferrer" className="w-full max-w-3xl">
      <div className="flex flex-col md:flex-row border border-gray-300 rounded-lg overflow-hidden shadow-lg w-full bg-white dark:bg-gray-800 mt-4 mb-4 transform transition-transform duration-200 hover:scale-105 cursor-pointer h-80">
